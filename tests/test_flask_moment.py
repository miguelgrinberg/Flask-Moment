...
class TestPrivateMomentClass(object):
    ...
    def test_fromNow_default(self):
        ...
        assert rts.find("data-function=\"fromNow\" data-argument=\"%s\"" %
                        int(no_suffix)) > 0
    ...
    def test_fromTime_default(self):
        ...
        assert rts.find("data-function=\"from\" data-argument=\"%s\" "
                        "data-timestamp2=\"%s\""
                        % (int(no_suffix), mom._timestamp_as_iso_8601(ts))) > 0
    ...
    def test_toNow_default(self):
        ...
        assert rts.find("data-function=\"toNow\" data-argument=\"%s\"" %
                        int(no_suffix)) > 0
    ...
    def test_toTime_default(self):
        ...
        assert rts.find("data-function=\"to\" data-argument=\"%s\" "
                        "data-timestamp2=\"%s\""
                        % (int(no_suffix), mom._timestamp_as_iso_8601(ts))) > 0
        assert rts.find("%s" % mom._timestamp_as_iso_8601(
            timestamp=mom.timestamp)) > 0
